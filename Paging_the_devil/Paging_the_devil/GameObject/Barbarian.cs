...
namespace Paging_the_devil.GameObject
{
    class Barbarian : Player
    {
        ...
        public Barbarian(Texture2D tex, Vector2 pos, int playerIndex, Controller controller) : base(tex, pos, playerIndex, controller)
        {
            ...
            Ability2 = new Cleave(TextureManager.mageSpellList[6], pos, lastInputDirection,this);
        ...
        {
            Ability ability = new Cleave(TextureManager.mageSpellList[6], pos, lastInputDirection, this);
