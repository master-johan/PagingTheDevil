...
namespace Paging_the_devil.GameObject
{
    class Knight : Player
    {
        ...
        public Knight(Texture2D tex, Vector2 pos, int playerIndex, Controller Controller) : base (tex, pos, playerIndex, Controller)
        {
            ...
            Ability2 = new Fireball(TextureBank.mageSpellList[0], pos, lastInputDirection);
        ...
        {
            Ability ability = new Fireball(TextureBank.mageSpellList[0], pos, lastInputDirection);
